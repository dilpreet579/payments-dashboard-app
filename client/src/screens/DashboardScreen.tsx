...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8, justifyContent: 'space-between', backgroundColor: '#fff' },
  title: { fontSize: 28, fontWeight: 'bold', marginVertical: 12, color: '#007AFF' },
  logoutButton: { backgroundColor: '#ff3b30', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 20, alignItems: 'center', marginTop: 8 },
